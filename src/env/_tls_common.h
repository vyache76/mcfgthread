...
typedef struct __MCFCRT_tagTlsKeyHandle /* incomplete */ *_MCFCRT_TlsKeyHandle;
...
typedef struct __MCFCRT_tagTlsThreadMapHandle /* incomplete */ *__MCFCRT_TlsThreadMapHandle;
