...
__attribute__((__noreturn__)) extern void __MCFCRT_MopthreadExit(void (*__pfnModifier)(void *, _MCFCRT_STD size_t, _MCFCRT_STD intptr_t), _MCFCRT_STD intptr_t __nContext) _MCFCRT_NOEXCEPT;
