...
typedef MopthreadState;

struct tagMopthreadControl
  {
...
static void AttachInitialThread(void)
  {
    ...
    if(!NT_SUCCESS(lStatus)) {
      _MCFCRT_Bail(L"NtDuplicateObject() failed: Could not create a handle to the initial thread.");
    }
